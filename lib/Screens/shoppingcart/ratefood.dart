...
import 'package:foodninja/Screens/shoppingcart/RateRestaurant.dart';
        ...
        child:  Padding(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Image.asset('assets/images/ratefood.png', height: 150.h,width: 150.w,),
                ...
                Text('Please rate your Food', style: TextStyle(fontSize: 20.sp, color: Colors.grey),),
                SizedBox(height: 20.h,),
                RatingBar.builder(
                    minRating: 1,
                ...
                SizedBox(height: 20.h,),
                TextformField(controller: ratefoodController, text: 'Leave feedback', icon: Icon(Icons.edit_note_sharp, color: greencolor,), textinputtype: TextInputType.text, obscureText: false,),
                ...
                Row(
                  children: [
                    Flexible(
                      child: Container(
                        ...
                        child: MaterialButton(
                          onPressed:(){Get.offAll( RateRestaurant());},
                          child: Text('Submit',
                    ...
                    InkWell(onTap:(){Get.offAll(RateRestaurant());},child: Text('Skip',style: TextStyle(color: greencolor,fontSize: 20.sp),))
